...
ENTRIES = [
    ...
    {"title": "Lambda", "title1": "x = lambda x, y: x+ y", "creation_date": datetime.datetime(2016, 12, 20, 0, 0), "body": "I learned some stuff about some other stuff."},
    {"title": "Learning from our Mistakes: Journey of a Computer Scientist", "title1": "How to iterate on improvement in the learning of programming.", "creation_date": datetime.datetime(2016, 12, 20, 0, 0), "body": "I learned some stuff about some other stuff."},
]
